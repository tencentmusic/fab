...
class Rabbit_info():
    def __init__(self, host=RABBITMQ_SERVER_IP, port=RABBITMQ_SERVER_PORT, user=RABBITMQ_SERVER_USER,password=RABBITMQ_SERVER_PASSWORD):
        self.url='http://'+host+':'+port+'/api/'
        self.user=user
